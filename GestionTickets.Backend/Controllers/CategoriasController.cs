...
namespace GestionTickets.Backend.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IDCategoria,NombreCategoria")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IDCategoria,NombreCategoria")] Categoria categoria)
        {
            if (ModelState.IsValid)
            {
